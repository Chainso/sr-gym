...
class OneHotDiscreteActionTransformer(ActionTransformer):
    """
    ...
    def __init__(self):
        ...
        self._action_space: OneHotDiscreteShaped = OneHotDiscreteShaped(
            len(OneHotDiscreteActionTransformer.ACTIONS)
        )
    ...
    def transform_action(
        ...
        """
        return OneHotDiscreteActionTransformer.ACTIONS[action]
